...
public class ExistingUsersStepBackTest extends ApiSteps {

    @Feature("Флоу прохождения онбординга")
    @Test(description = "Проверка возможности прохождения онбординг флоу используя возможность возврата по флоу")
    void existingClientStepBackTest() throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, IOException, InterruptedException {
